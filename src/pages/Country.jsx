        ...
        <div className="">
            <div className="mt-8 lg:mt-20 pb-28 px-[7%] 2xl:px-0 text-blue-black dark:text-white max-w-[1280px] mx-auto">
                <div>
                    <button
                        onClick={() => navigate(-1)}
                        className="transition-all duration-500 flex items-center gap-1 bg-white dark:bg-blue-dark shadow-md px-6 lg:px-8 active:scale-95 py-2 rounded-sm hover:scale-105"
                    >
                        <svg
                        ...
                        {borders && (
                            <div className="mt-10 lg:flex items-center gap-4">
                                ...
                                <div className="flex flex-wrap gap-3 mt-6 lg:mt-0">
                                    {borders.map((c) => (
                                        <BorderCountryButton key={c} code={c} />
                                    ))}
                                    {/* {borders.map((c) => (
                                        <h3>{c}</h3>
                                    ))} */}
