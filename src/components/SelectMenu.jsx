...
import { setSelect } from '../features/countriesSlice'
...
export default function SelectMenu() {
    ...
    const { selectValue } = useSelector((store) => store.countries)
    const dispatch = useDispatch()
    function handleSelect(value) {
        // console.log(value, 'cehck')
        dispatch(setSelect(value))
    }
    return (
        <Listbox value={selectValue} onChange={handleSelect}>
            {({ open }) => (
                <>
